...
if __name__ == '__main__':
    ...
    parser.add_argument('--models_path', type=str, default='/Users/waf/Developer/temp_floor/floor/logs/weights/lstm/lstm_final_3')
    parser.add_argument('--out_path', type=str, default='/Users/waf/Developer/temp_floor/floor/logs/weights/lstm/lstm_final_3/final.csv')
