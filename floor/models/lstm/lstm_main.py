...
def fit_feedforward(hparams, exp, trial_nb, data):
    ...
    model.add(LSTM(hparams.nb_rnn_units_l1, return_sequences=True, dropout=hparams.drop_rate,
    ...
    checkpoint = ModelCheckpoint(model_path,
                                 ...
                                 save_best_only=True,
                                 mode='max')
    earlystop = EarlyStopping(monitor='acc', min_delta=0.0001, patience=20,
                              verbose=1, mode='auto')
...
if __name__ == '__main__':
    ...
    parser.add_opt_argument_list('--learning_rate', default=0.006, options=[0.004, 0.005, 0.006, 0.007], type=float, tunnable=True)
    ...
    parser.add_argument('--tt_name', default='lstm_final_3')
